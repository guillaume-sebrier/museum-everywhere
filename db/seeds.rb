...
offer = Offer.new(title: "Matchbox models (including Tour Eiffel!!)", description: Faker::Restaurant.description, user: User.all.sample, price: 9, address: "12 avenue Wagram, Paris", category: "Unusual collection", duration: 45)
...
offer = Offer.new(title: "Splendid gardens", description: Faker::Restaurant.description, user: User.all.sample, price: 12, address: "12 avenue de Versailles, Paris", category: "Gardens & plants", duration: 45)
...
offer = Offer.new(title: "Jean Prouvé's flat", description: Faker::Restaurant.description, user: User.all.sample, price: 8, address: "12 rue des Renaudes, Paris", category: "Famous People Flat", duration: 60)
